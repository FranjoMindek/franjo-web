  ...
  return (
    <div className='page-container'>
      <div className='flex max-w-prose flex-col gap-16 sm:gap-20'>
        {/* About */}
        <div>
          <h1 className='mb-12 text-5xl font-bold sm:mb-14 sm:text-6xl'>
            About
          </h1>
          <div
        ...
        <div>
          ...
          <div className='flex flex-col gap-12 divide-coffee sm:gap-14'>
...
async function fetchData(): Promise<AboutPageVM> {
